...
return array(
    ...
    'BrianHenryIE\\WP_Logger\\API\\API' => $vendorDir . '/brianhenryie/bh-wp-logger/src/API/class-api.php',
    'BrianHenryIE\\WP_Logger\\API\\BH_WP_PSR_Logger' => $vendorDir . '/brianhenryie/bh-wp-logger/src/API/class-bh-wp-psr-logger.php',
    'BrianHenryIE\\WP_Logger\\API\\Logger_Settings' => $vendorDir . '/brianhenryie/bh-wp-logger/src/API/class-logger-settings.php',
    'BrianHenryIE\\WP_Logger\\API_Interface' => $vendorDir . '/brianhenryie/bh-wp-logger/src/interface-api.php',
    'BrianHenryIE\\WP_Logger\\Admin\\AJAX' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Admin/class-ajax.php',
    'BrianHenryIE\\WP_Logger\\Admin\\Admin_Notices' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Admin/class-admin-notices.php',
    'BrianHenryIE\\WP_Logger\\Admin\\Logs_List_Table' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Admin/class-logs-list-table.php',
    'BrianHenryIE\\WP_Logger\\Admin\\Logs_Page' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Admin/class-logs-page.php',
    'BrianHenryIE\\WP_Logger\\Admin\\Plugins_Page' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Admin/class-plugins-page.php',
    'BrianHenryIE\\WP_Logger\\Logger' => $vendorDir . '/brianhenryie/bh-wp-logger/src/class-logger.php',
    'BrianHenryIE\\WP_Logger\\Logger_Settings_Interface' => $vendorDir . '/brianhenryie/bh-wp-logger/src/interface-logger-settings.php',
    'BrianHenryIE\\WP_Logger\\Logger_Settings_Trait' => $vendorDir . '/brianhenryie/bh-wp-logger/src/trait-logger-settings.php',
    'BrianHenryIE\\WP_Logger\\PHP\\PHP_Error_Handler' => $vendorDir . '/brianhenryie/bh-wp-logger/src/PHP/class-php-error-handler.php',
    'BrianHenryIE\\WP_Logger\\PHP\\PHP_Shutdown_Handler' => $vendorDir . '/brianhenryie/bh-wp-logger/src/PHP/class-php-shutdown-handler.php',
    'BrianHenryIE\\WP_Logger\\Private_Uploads\\URL_Is_Public' => $vendorDir . '/brianhenryie/bh-wp-logger/src/Private_Uploads/class-url-is-public.php',
    'BrianHenryIE\\WP_Logger\\WP_Includes\\Cron' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WP_Includes/class-cron.php',
    'BrianHenryIE\\WP_Logger\\WP_Includes\\Functions' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WP_Includes/class-functions.php',
    'BrianHenryIE\\WP_Logger\\WP_Includes\\Plugin_Logger_Actions' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WP_Includes/class-plugin-logger-actions.php',
    'BrianHenryIE\\WP_Logger\\WP_Includes\\Plugins' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WP_Includes/class-plugins.php',
    'BrianHenryIE\\WP_Logger\\WooCommerce\\Log_Handler' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WooCommerce/class-log-handler.php',
    'BrianHenryIE\\WP_Logger\\WooCommerce\\WC_PSR_Logger' => $vendorDir . '/brianhenryie/bh-wp-logger/src/WooCommerce/class-wc-psr-logger.php',
    'BrianHenryIE\\WP_Logger\\WooCommerce_Logger_Settings_Interface' => $vendorDir . '/brianhenryie/bh-wp-logger/src/interface-woocommerce-logger-settings.php',
    'BrianHenryIE\\WP_Private_Uploads\\API\\API' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/API/class-api.php',
    'BrianHenryIE\\WP_Private_Uploads\\API_Interface' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/interface-api.php',
    'BrianHenryIE\\WP_Private_Uploads\\Admin\\Admin_Notices' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/Admin/class-admin-notices.php',
    'BrianHenryIE\\WP_Private_Uploads\\Frontend\\Serve_Private_File' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/Frontend/class-serve-private-file.php',
    'BrianHenryIE\\WP_Private_Uploads\\Private_Uploads' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/class-private-uploads.php',
    'BrianHenryIE\\WP_Private_Uploads\\Private_Uploads_Settings_Interface' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/interface-private-uploads-settings.php',
    'BrianHenryIE\\WP_Private_Uploads\\Private_Uploads_Settings_Trait' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/trait-private-uploads-settings.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\BH_WP_Private_Uploads' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-bh-wp-private-uploads.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\CLI' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-cli.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\Cron' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-cron.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\Post' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-post.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\REST_Private_Uploads_Controller' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-rest-private-uploads-controller.php',
    'BrianHenryIE\\WP_Private_Uploads\\WP_Includes\\WP_Rewrite' => $vendorDir . '/brianhenryie/bh-wp-private-uploads/src/WP_Includes/class-wp-rewrite.php',
