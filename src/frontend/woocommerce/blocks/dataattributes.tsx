import {getClassNameFromNamespacedName, getLocalNameFromNamespacedName} from "./names";

export function getAttributes( element: Element, attributes: string[] ): {
...
export function getContext( element: Element, contextItemNames: string[] ): {
    [ key: string ]: string | boolean | number;
} {
