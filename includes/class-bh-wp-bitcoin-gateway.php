...
use BrianHenryIE\WP_Bitcoin_Gateway\WooCommerce\Blocks\Order_Confirmation\Bitcoin_Payment_Status_Block;
...
class BH_WP_Bitcoin_Gateway {
	...
	protected function define_thank_you_hooks(): void {
		...
		/** @var Bitcoin_Payment_Status_Block $bitcoin_payment_status_block */
		$bitcoin_payment_status_block = $this->container->get( Bitcoin_Payment_Status_Block::class );
