...
/**
 * Register the `bh-wp-bitcoin-gateway/payment-last-checked` block.
 *
 * @see assets/js/frontend/woocommerce/blocks/order-confirmation/payment-last-checked/block.json
 */
class Bitcoin_Order_Payment_Last_Checked_Block {
	...
	public function register_block(): void {
		register_block_type(
			$this->settings->get_plugin_dir() . 'assets/js/frontend/woocommerce/blocks/order-confirmation/payment-last-checked/'
		);
	}
}
